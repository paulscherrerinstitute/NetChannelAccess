...
namespace PSI.EpicsClient2
{
    ...
    enum CommandID : ushort
    {
        ...
        /// CA protocol version
        /// </summary>
        CA_PROTO_VERSION = (ushort)0x00,

        /// <summary>
        /// Register monitor
        /// </summary>
        CA_PROTO_EVENT_ADD = (ushort)0x01,

        /// <summary>
        /// Unregister monitor
        /// </summary>
        CA_PROTO_EVENT_CANCEL = (ushort)0x02,

        /// <summary>
        /// Read channel value (without notification)
        /// </summary>
        CA_PROTO_READ = (ushort)0x03,

        /// <summary>
        /// Write channel value (without notification)
        /// </summary>
        CA_PROTO_WRITE = (ushort)0x04,

        /// <summary>
        /// Search for a channel
        /// </summary>
        CA_PROTO_SEARCH = (ushort)0x06,

        /// <summary>
        /// Disable monitor events
        /// </summary>
        CA_PROTO_EVENTS_OFF = (ushort)0x08,

        /// <summary>
        /// Enable monitor events
        /// </summary>
        CA_PROTO_EVENTS_ON = (ushort)0x09,

        /// <summary>
        /// Error during operation
        /// </summary>
        CA_PROTO_ERROR = (ushort)0x0B,

        /// <summary>
        /// Release channel resources
        /// </summary>
        CA_PROTO_CLEAR_CHANNEL = (ushort)0x0C,

        /// <summary>
        /// Server beacon
        /// </summary>
        CA_PROTO_RSRV_IS_UP = (ushort)0x0D,

        /// <summary>
        /// Channel not found
        /// </summary>
        CA_PROTO_NOT_FOUND = (ushort)0x0E,
